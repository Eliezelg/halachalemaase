    ...
    >
      ...
      <div className="mb-12 max-w-4xl mx-auto bg-white rounded-lg shadow-md p-6" dir="rtl">
        ...
        <div className="space-y-4 text-right">
          ...
          <p>
        הלוח הינו עזרה ראשונה לדעת כיצד לנהוג למעשה בכל רגע נתון, את ההסבר והטעם ניתן לראות בספרי הליכות ברכות לפי ציוני המקורות המופיעים שם בלוח ברכות"
        </p>
        <p>
